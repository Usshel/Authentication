...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'control-name', component: FormControlNameComponent }, { path: 'control-age', component: FormControlAgeComponent }]), FormControlNameComponentModule, FormControlAgeComponentModule],
